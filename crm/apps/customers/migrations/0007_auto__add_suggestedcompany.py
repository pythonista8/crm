...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuggestedCompany'
        db.create_table('customers_suggestedcompany', (
        ...
        db.send_create_signal('customers', ['SuggestedCompany'])


    def backwards(self, orm):
        # Deleting model 'SuggestedCompany'
        db.delete_table('customers_suggestedcompany')
    ...
    models = {
        ...
        'customers.amount': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'amounts'", 'to': "orm['customers.Customer']"}),
        ...
        'customers.customer': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'customers'", 'to': "orm['accounts.User']"}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'})
        },
        'customers.suggestedcompany': {
            'Meta': {'object_name': 'SuggestedCompany'},
